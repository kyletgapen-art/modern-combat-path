...
const WARMUPS = [
  ...
  { name: "High Knees", note: "Drive knees to hip height — fast feet", prescription: "2 × 20m or 30 sec" },
  { name: "Butt Kicks", note: "Heel to glute — quick turnover", prescription: "2 × 20m or 30 sec" },
  ...
  { name: "Single Leg Hops", note: "Light — 10 each leg", prescription: "2 × 10 each" },
  // Mobility / Joint Prep
  ...
  // Stretching / Recovery (former cooldowns — equally useful before training)
  ...
  { name: "Wrist and Forearm Stretch", note: "Fingers forward and fingers back — essential before any pressing or bag work", prescription: "30 sec each direction" },
